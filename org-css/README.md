...
The src github repo is https://github.com/gongzhitaao/orgcss.
The template html is in the "doc" folder.
The template html source org file is in the "src" folder.
The website for demonstrating the effect of the css is https://gongzhitaao.org/orgcss/
